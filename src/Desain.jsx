    ...
    return (
        <div className="Desain">
            <div className="container">
                <p className="text_desain">
                    Features
                </p>
                <h1 className="title_desain">
                    Design that solves problems, one product at a time
                </h1>
                <div className="desain_cards">
                    <div className="Cards_1">
                        ...
                        <h1 className="Card_title">Uses Client First</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>
                    ...
                    <div className="Cards_1">
                        ...
                        <h1 className="Card_title">Two Free Revision Round</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>
                    ...
                    <div className="Cards_1">
                        ...
                        <h1 className="Card_title">Template Customization</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>

                    </div>
                </div>
                <div className="desain_cards2">
                    <div className="Cards_1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                        ...
                        <h1 className="Card_title">24/7 Support</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>
                    ...
                    <div className="Cards_1">
                        ...
                        <h1 className="Card_title">Quick Delivery</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>
                    ...
                    <div className="Cards_1">
                        ...
                        <h1 className="Card_title">Hands-on approach</h1>
                        <p className="Card_text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore at modi fugit officiis facilis officia corporis, provident id voluptates excepturi fugiat incidunt libero cupiditate sed.F</p>
