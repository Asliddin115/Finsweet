            ...
            <div className="container">
                <div className="talk_content">
                    <div className="talk_right">
                        <img className="Talk_logo" src={Logo} alt="" />
                        <h1 className="talk_right_title">We are always open to discuss your project and improve your online presence.</h1>
                        <div className="right_yellow">
                            <div className="right_yellow_right">
                                <h1 className="logo_maisl">Email me at</h1>
                                <h1 className="logo_mail">contact@website.com</h1>
                            </div>
                            <div className="left_yellow">
                                <h1 className="talk_call"><a href="tel:0927 6277 28525" >Call us</a></h1>
                                <h1 className="phone_number">0927 6277 28525</h1>
                            </div>
                        </div>
                    </div>
                    <div className="right_cont">
                        <h1 className="right_title">
                            Lets Talk!
                        </h1>
                        <p className="right_text">We are always open to discuss your project, improve your online presence and help with your UX/UI design challenges.</p>
                        <div className="icones">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <g clip-path="url(#clip0_3906_389)">
                                ...
                                <defs>
                                    <clipPath id="clip0_3906_389">
                                        <rect width="16" height="16" fill="white" />
                                    </clipPath>
                                </defs>
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                <g clip-path="url(#clip0_3906_391)">
